...
public partial class LineDialogModel : LineModel
{
    ...
    public string IconSrc => CharacterId is > 0 and <= 31
        ? $"avares://SekaiToolsAvalonia/Assets/Characters/chr_{CharacterId}.png"
        : "";

    public bool HasIcon => IconSrc.Length > 0;
    ...
    private static string FormatContent(string content)
    {
        return content.Replace("…", "...").Replace('(', '（').Replace(')', '）')
            .Replace(',', '，').Replace('?', '？').Replace('!', '！').Replace('欸', '诶');
    }
